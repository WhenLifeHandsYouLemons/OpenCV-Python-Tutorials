...
#            else: objectType="None"
            ...
            cv2.putText(imgContour, objectType, (x + (w // 2) - 40, y + (h // 2) + 10), cv2.FONT_HERSHEY_COMPLEX, 0.8, (0, 0, 0), 2)
...
imgStack = stackImages(0.6, ([img, imgGrey, imgBlur], [imgCanny, imgContour, imgBlank]))
